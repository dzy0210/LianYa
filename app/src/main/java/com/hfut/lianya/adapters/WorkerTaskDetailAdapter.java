...
public class WorkerTaskDetailAdapter extends RecyclerView.Adapter<WorkerTaskDetailAdapter.ViewHolder> {
    ...
    public WorkerTaskDetailAdapter(List<Fkpb> list, OnItemClickListener listener) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_worker_doing_task_detail, parent, false);
